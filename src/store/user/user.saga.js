...
import { signInSucess, signInFailure, googleSignInStart, signUpSuccess, signUpFailure, signOutFailure, signOutSuccess } from "./user.action";
...
export function* getSnapshotFromUserAuth(userAuth, addtionalDetials) {
    try{
        const userSnapshot = yield call(createUserDocumentFromAuth, userAuth, addtionalDetials); 
